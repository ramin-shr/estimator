...
namespace QuoterPlan
{
	public class CommandDelete : Command
	{
		...
		public CommandDelete(DrawingArea drawArea, string layerName)
		{
			...
			if (layer != null)
			{
				...
				using (IEnumerator<DrawObject> enumerator = layer.DrawingObjects.Selection.GetEnumerator())
				{
					while (enumerator.MoveNext())
					{
						...
						Console.WriteLine("Delete " + drawObject.ID);
					}
					return;
				}
			}
		...
		public override void Undo()
		{
			...
			if (layer != null)
			{
				...
				for (int i = count - 1; i >= 0; i--)
				{
					...
					Console.WriteLine("Delete::Undo " + drawObject.ID);
				}
			...
			if (layer != null)
			{
				...
				for (int i = count - 1; i >= 0; i--)
				{
					...
					if (flag)
					{
						...
						Console.WriteLine("Delete::Redo " + drawObject.ID);
					}
				}
				this.drawArea.Owner.ReloadObjectsInGUI();
				return;
