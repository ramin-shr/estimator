...
namespace QuoterPlan
{
	public class ReportsControl : UserControl
	{
		public event EventHandler OnSelectReport
		{
			add
			{
				EventHandler eventHandler = this.OnSelectReport;
				EventHandler eventHandler2;
				do
				{
					eventHandler2 = eventHandler;
					EventHandler value2 = (EventHandler)Delegate.Combine(eventHandler2, value);
					eventHandler = Interlocked.CompareExchange<EventHandler>(ref this.OnSelectReport, value2, eventHandler2);
				}
		...
		public event EventHandler OnApplySettings
		{
			add
			{
				EventHandler eventHandler = this.OnApplySettings;
				EventHandler eventHandler2;
				do
				{
					eventHandler2 = eventHandler;
					EventHandler value2 = (EventHandler)Delegate.Combine(eventHandler2, value);
					eventHandler = Interlocked.CompareExchange<EventHandler>(ref this.OnApplySettings, value2, eventHandler2);
				}
				while (eventHandler != eventHandler2);
			}
			remove
		...
		public event EventHandler OnCancelSettings
		{
			add
			{
				EventHandler eventHandler = this.OnCancelSettings;
				EventHandler eventHandler2;
				do
				{
					eventHandler2 = eventHandler;
					EventHandler value2 = (EventHandler)Delegate.Combine(eventHandler2, value);
					eventHandler = Interlocked.CompareExchange<EventHandler>(ref this.OnCancelSettings, value2, eventHandler2);
				}
				while (eventHandler != eventHandler2);
			}
			remove
		...
		private void CreateXMLReport(ref DataSet dataSet, bool processSummariesDataSet = false)
		{
			...
			try
			{
				...
				string text = this.reportModule.ExportToXML(currentReportType == ReportTypeEnum.EstimatingByGroupsReport || currentReportType == ReportTypeEnum.EstimatingByPlansReport || currentReportType == ReportTypeEnum.QuoteReport, true);
				if (currentReportType == ReportTypeEnum.QuoteReport)
				{
					QuoteReportGenerator quoteReportGenerator = new QuoteReportGenerator();
					text = quoteReportGenerator.Generate(new MemoryStream(Encoding.UTF8.GetBytes(text ?? "")), this.project.Report.QuoteReportSortBy, this.project, this.dbManagement);
					if (text == "")
					{
						return;
					}
		...
		public void UpdateReport()
		{
			...
			try
			{
				...
				{
					XtraReportEstimatingTotalsByPlans xtraReportEstimatingTotalsByPlans = new XtraReportEstimatingTotalsByPlans(this.project);
					xtraReportEstimatingTotalsByPlans.DataSource = this.summariesDataSet;
					xtraReportEstimatingTotalsByPlans.CreateDocument();
					this.xtraReport[(int)currentReportType].Pages.AddRange(xtraReportEstimatingTotalsByPlans.Pages);
		...
		{
			string text = Path.GetFileNameWithoutExtension(this.project.FileName);
			switch (this.CurrentReportTab)
			{
			case ReportTabEnum.TakeoffReportTab:
				text = text + "-" + ((this.project.Report.Order == Report.ReportOrderEnum.ReportOrderByObjects) ? Resources.Rapport_de_métré_par_groupes : ((this.project.Report.ReportSortBy == Report.ReportSortByEnum.ReportSortByPlans) ? Resources.Rapport_de_métré_par_plans : Resources.Rapport_de_métré_par_calques));
				break;
			case ReportTabEnum.EstimatingReportTab:
				text = text + "-" + ((this.project.Report.Order == Report.ReportOrderEnum.ReportOrderByObjects) ? Resources.Rapport_d_estimation_par_groupes : ((this.project.Report.ReportSortBy == Report.ReportSortByEnum.ReportSortByPlans) ? Resources.Rapport_d_estimation_par_plans : Resources.Rapport_d_estimation_par_calques));
				break;
			case ReportTabEnum.QuoteReportTab:
				text = text + "-" + Resources.Rapport_devis;
				break;
			case ReportTabEnum.InvoiceReportTab:
				text = text + "-" + Resources.Rapport_facture;
				break;
			}
			return Path.Combine(Utilities.GetReportsFolder(), text.Replace(' ', '-'));
		}

		public void ExportToExcel()
		{
			string fileName = this.GetExportFileName() + ".xls";
			Settings.Default.ExportToExcelType = 0;
			this.reportModule.ExportToExcel(fileName, this.CurrentReportTab == ReportTabEnum.EstimatingReportTab);
		}

		public void ExportToXML()
		{
			ReportTypeEnum currentReportType = this.CurrentReportType;
			this.reportModule.ExportToXML(currentReportType == ReportTypeEnum.EstimatingByGroupsReport || currentReportType == ReportTypeEnum.EstimatingByPlansReport, false);
		}

		private bool ExportToCOfficeFile(string sExportFilename, CEstimatingItems CEstimatingItems)
		{
			string text = "Page,Digitizer Item,Item Number,Total,Units,Color," + Environment.NewLine;
			foreach (CEstimatingItem cestimatingItem in CEstimatingItems.Collection)
			{
				Variable variable = (Variable)cestimatingItem.Tag;
				...
				text = text + cestimatingItem.ItemID + ",";
				text = text + variable.Tag + ",";
				text = text + cestimatingItem.Unit + ",";
				text = text + "," + Environment.NewLine;
			}
			return Utilities.SaveStringToFile(sExportFilename, text);
		}
		...
		{
			string text = this.GetExportFileName() + ".html";
			try
			{
				this.xtraReport[(int)this.CurrentReportType].ExportOptions.Html.ExportMode = HtmlExportMode.SingleFilePageByPage;
				this.xtraReport[(int)this.CurrentReportType].ExportToHtml(text);
				Utilities.OpenDocument(text);
			}
			catch (Exception exception)
			{
				Utilities.DisplaySystemError(exception);
		...
		{
			string fileName = this.GetExportFileName() + ".pdf";
			if (this.DoExportToPDF(fileName))
			{
		...
		private void InitializeComponent()
		{
			...
			this.superTabProperties.ControlBox.SubItems.AddRange(new BaseItem[]
			{
			...
			this.superTabProperties.Tabs.AddRange(new BaseItem[]
			{
				this.superTabItemTakeoff,
				this.superTabItemEstimating,
				this.superTabItemQuote,
				this.superTabItemInvoice
			});
			...
			this.superTabControlPanel3.Resize += this.superTabControlPanel3_Resize;
			...
			this.ribbonBarQuoteSettings.Items.AddRange(new BaseItem[]
			{
				this.itemContainer5,
				this.labelItem18,
				this.btQuoteSettingsTaxes,
				this.labelItem19,
				this.labelItem23,
				...
				this.labelItem27,
				this.labelItem28,
				this.btQuoteSettingsApply,
				this.btQuoteSettingsCancel
			});
			...
			this.itemContainer5.SubItems.AddRange(new BaseItem[]
			{
				this.labelItem6,
				this.labelItem16,
				this.lblQuoteEnableFilter,
				this.switchQuoteEnableFilter
			});
			...
			this.btQuoteSettingsTaxes.Click += this.btSettingsTaxes_Click;
			...
			this.itemContainer11.SubItems.AddRange(new BaseItem[]
			{
				this.labelItem24,
				this.checkBoxQuoteShowInvisibleObjects,
				this.labelItem25
			});
			...
			this.btQuoteSettingsApply.Click += this.btQuoteSettingsApply_Click;
			...
			this.btQuoteSettingsCancel.Click += this.btSettingsCancel_Click;
			...
			this.superTabControlPanel2.Resize += this.superTabControlPanel2_Resize;
			...
			this.ribbonBarEstimatingSettings.Items.AddRange(new BaseItem[]
			{
				this.itemContainer3,
				this.labelItem15,
				this.btEstimatingSettingsTaxes,
				this.lblEstimatingSortBySeparator,
				this.containerConsolidatedBy,
				this.labelItem7,
				this.itemContainer4,
				this.labelItem10,
				this.labelItem11,
				this.labelItem12,
				this.btEstimatingSettingsApply,
				this.btEstimatingSettingsCancel
			});
			...
			this.itemContainer3.SubItems.AddRange(new BaseItem[]
			{
				this.labelItem4,
				this.labelItem5,
				this.lblEstimatingEnableFilter,
				this.switchEstimatingEnableFilter
			});
			...
			this.btEstimatingSettingsTaxes.Click += this.btSettingsTaxes_Click;
			...
			this.containerConsolidatedBy.SubItems.AddRange(new BaseItem[]
			{
				this.itemContainer7,
				this.itemContainer8
			});
			...
			this.itemContainer7.SubItems.AddRange(new BaseItem[]
			{
				this.lblEstimatingConsolidateBy,
				this.opEstimatingConsolidateByGroups,
				this.opEstimatingConsolidateByItems,
				this.labelItem14
			});
			...
			this.itemContainer8.SubItems.AddRange(new BaseItem[]
			{
				this.labelItem13,
				this.btEditEstimatingSections
			});
			...
			this.itemContainer4.SubItems.AddRange(new BaseItem[]
			{
				this.labelItem8,
				this.checkBoxEstimatingShowProjectInfo,
				this.checkBoxEstimatingShowComments,
				this.checkBoxEstimatingShowInvisibleObjects,
				this.labelItem9
			});
			...
			this.btEstimatingSettingsApply.Click += this.btEstimatingSettingsApply_Click;
			...
			this.btEstimatingSettingsCancel.Click += this.btSettingsCancel_Click;
			...
			this.superTabControlPanel1.Resize += this.superTabControlPanel1_Resize;
			...
			this.ribbonBarTakeoffSettings.Items.AddRange(new BaseItem[]
			{
				this.itemContainer2,
				this.lblBarTakeoffReportPadding4,
				this.itemContainer1,
				this.lblBarTakeoffReportPadding1,
				this.lblBarTakeoffReportSeparator,
				this.lblBarTakeoffReportPadding3,
				this.btTakeoffSettingsApply,
				this.btTakeoffSettingsCancel
			});
			...
			this.itemContainer2.SubItems.AddRange(new BaseItem[]
			{
				this.labelItem2,
				this.labelItem3,
				this.lblTakeoffEnableFilter,
				this.switchTakeoffEnableFilter
			});
			...
			{
				this.lblBarTakeoffReportPadding2,
				this.checkBoxTakeoffShowProjectInfo,
				this.checkBoxTakeoffShowComments,
				this.checkBoxTakeoffShowInvisibleObjects,
				this.labelItem1
			});
			...
			this.btTakeoffSettingsApply.Click += this.btTakeoffSettingsApply_Click;
			...
			this.btTakeoffSettingsCancel.Click += this.btSettingsCancel_Click;
		...
		private EventHandler OnSelectReport;

		private EventHandler OnApplySettings;

		private EventHandler OnCancelSettings;
