...
namespace QuoterPlan
{
	internal class ToolNote : ToolRectangle
	{
		private DrawNote NewNote
		{
			...
			get
			{
				return this.<NewNote>k__BackingField;
			}
			[CompilerGenerated]
			set
			{
				this.<NewNote>k__BackingField = value;
			}
		}
		...
		public override void InitializeTool(Cursor cursor)
		{
			...
			{
				Resources.Cliquez_et_étirez_la_position_de_la_note,
				"  |  ",
		...
		public override void OnMouseDown(MouseEventArgs e)
		{
			...
			this.NewNote = new DrawNote((int)((float)point.X + base.DrawArea.DrawingBoard.Origin.X), (int)((float)point.Y + base.DrawArea.DrawingBoard.Origin.Y), base.DrawArea.ToolSettings.Name, base.DrawArea.ToolSettings.Comment, base.DrawArea.ToolSettings.LineColor, base.DrawArea.ToolSettings.FillColor, base.DrawArea.ToolSettings.Opacity, base.DrawArea.ToolSettings.DrawFilled, base.DrawArea.ToolSettings.LineWidth, 32);
			...
			string status = string.Concat(new string[]
			{
				Resources.Déplacez_la_position_de_la_note,
				"  |  ",
		...
		public override void TrackMouse(Point location)
		{
			...
			base.Move(this.NewNote, deltaX, deltaY);
			this.LastPoint = new Point(point.X, point.Y);
			this.LastOrigin = new Point((int)base.DrawArea.DrawingBoard.Origin.X, (int)base.DrawArea.DrawingBoard.Origin.Y);
			base.Tracking = false;
		}
		...
		[CompilerGenerated]
		private DrawNote <NewNote>k__BackingField;
