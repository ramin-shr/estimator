...
{
	public class XtraReportEstimatingByGroups : XtraReport
	{
		...
		private void InitializeComponent()
		{
			...
			ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof(XtraReportEstimatingByGroups));
			...
			this.lblHeader2.LocationFloat = new PointFloat(777.7067f, 37.53125f);
			...
			this.lblHeader1.LocationFloat = new PointFloat(777.7067f, 20.53126f);
			...
			this.lbHeaderPageInfo.LocationFloat = new PointFloat(749f, 58.3021f);
			...
			this.lblFooter2.LocationFloat = new PointFloat(322.855f, 49.99997f);
			...
			this.lblFooter1.LocationFloat = new PointFloat(322.855f, 35.00003f);
			...
			this.lbFooterlPageInfo.LocationFloat = new PointFloat(749.0001f, 37.5f);
			...
			this.SubBand5.HeightF = 34.99997f;
			...
			this.xrLabel3.LocationFloat = new PointFloat(325f, 12.5f);
			...
			this.Detail3.HeightF = 25.00003f;
			...
			this.xrLabel24.LocationFloat = new PointFloat(32.00014f, 2.000014f);
			...
			this.xrLabel6.LocationFloat = new PointFloat(10.00001f, 4.000028f);
			...
			this.SubBand10.FormattingRules.Add(this.formattingRule18);
			this.SubBand10.HeightF = 20f;
			...
			this.xrLabel7.Font = new Font("Tahoma", 6.75f, FontStyle.Bold, GraphicsUnit.Point, 0);
			this.xrLabel7.ForeColor = Color.FromArgb(64, 64, 64);
			this.xrLabel7.FormattingRules.Add(this.formattingRule9);
			this.xrLabel7.LocationFloat = new PointFloat(32f, 0f);
			this.xrLabel7.Multiline = true;
			this.xrLabel7.Name = "xrLabel7";
			this.xrLabel7.Padding = new PaddingInfo(6, 2, 2, 2, 100f);
			this.xrLabel7.SizeF = new SizeF(868.0001f, 18f);
			...
			this.formattingRule9.DataMember = "Objects.Objects_Object.Object_Extensions.Extensions_Extension.Extension_Results.Results_Result";
			this.formattingRule9.Formatting.Visible = DefaultBoolean.True;
			this.formattingRule9.Name = "formattingRule9";
			this.formattingRule18.Condition = "!IsNullOrEmpty([Comment])";
			this.formattingRule18.DataMember = "Objects.Objects_Object";
			...
			this.DetailReport3.Scripts.OnBeforePrint = "DetailReport3_BeforePrint";
			...
			this.Detail4.FormattingRules.Add(this.formattingRule9);
			this.Detail4.HeightF = 23f;
			this.Detail4.Name = "Detail4";
			this.Detail4.Scripts.OnBeforePrint = "Detail4_BeforePrint";
			...
			{
				new XRBinding("Text", null, "Objects.Objects_Object.Object_Extensions.Extensions_Extension.Extension_Results.Results_Result.EstimatingCaption")
			});
			...
			{
				new XRBinding("Text", null, "Objects.Objects_Object.Object_Extensions.Extensions_Extension.Extension_Results.Results_Result.Quantity")
			});
			...
			{
				new XRBinding("Text", null, "Objects.Objects_Object.Object_Extensions.Extensions_Extension.Extension_Results.Results_Result.EstimatingUnit")
			});
			...
			{
				new XRBinding("Text", null, "Objects.Objects_Object.Object_Extensions.Extensions_Extension.Extension_Results.Results_Result.CostEach")
			});
			...
			{
				new XRBinding("Text", null, "Objects.Objects_Object.Object_Extensions.Extensions_Extension.Extension_Results.Results_Result.CostTotal")
			});
			...
			{
				new XRBinding("Text", null, "Objects.Objects_Object.Object_Extensions.Extensions_Extension.Extension_Results.Results_Result.PriceEach")
			});
			...
			{
				new XRBinding("Text", null, "Objects.Objects_Object.Object_Extensions.Extensions_Extension.Extension_Results.Results_Result.PriceTotal")
			});
			...
			{
				new XRBinding("Text", null, "Objects.Objects_Object.Object_Extensions.Extensions_Extension.Extension_Results.Results_Result.Margin")
			});
			...
			this.formattingRule12.DataMember = "Objects.Objects_Object.Object_Extensions.Extensions_Extension.Extension_Results.Results_Result";
			...
			this.xrLabel1.Font = new Font("Tahoma", 6.75f, FontStyle.Bold, GraphicsUnit.Point, 0);
			this.xrLabel1.ForeColor = Color.DarkRed;
			this.xrLabel1.FormattingRules.Add(this.formattingRule19);
			this.xrLabel1.LocationFloat = new PointFloat(0f, 0f);
			this.xrLabel1.Multiline = true;
			this.xrLabel1.Name = "xrLabel1";
			this.xrLabel1.Padding = new PaddingInfo(10, 2, 4, 2, 100f);
			this.xrLabel1.SizeF = new SizeF(900.0001f, 18f);
			...
			this.formattingRule19.DataMember = "Objects.Objects_Object.Object_Extensions.Extensions_Extension";
			...
			{
				new XRBinding("Text", null, "Objects.Objects_Object.Object_Summary.CostTotalSubTotal")
			});
			...
			{
				new XRBinding("Text", null, "Objects.Objects_Object.Object_Summary.PriceTotalSubTotal")
			});
			...
			{
				new XRBinding("Text", null, "Objects.Objects_Object.Object_Summary.MarginSubTotal")
			});
			...
			this.formattingRule13.DataMember = "Objects.Objects_Object.Object_Summary";
			...
			this.xrLabel14.SizeF = new SizeF(257.29f, 2f);
			...
			this.lblReportTitle.LocationFloat = new PointFloat(125f, 0f);
			...
			this.lblReportTitle.Text = "RAPPORT D'ESTIMATION (PAR GROUPES)";
			...
			this.formattingRule10.DataMember = "Objects.Objects_Object.Object_Extensions.Extensions_Extension";
			...
			this.formattingRule11.DataMember = "Objects.Objects_Object.Object_Extensions.Extensions_Extension";
			this.formattingRule11.Formatting.Visible = DefaultBoolean.True;
			this.formattingRule11.Name = "formattingRule11";
			this.xrControlStyle1.BorderColor = Color.Gray;
			this.xrControlStyle1.BorderDashStyle = BorderDashStyle.Dot;
			this.xrControlStyle1.Borders = BorderSide.Bottom;
			this.xrControlStyle1.BorderWidth = 2f;
			this.xrControlStyle1.ForeColor = Color.Maroon;
			...
			this.xrTableCell36.Weight = 1.6355554050560623;
			...
			this.xrTableCell37.Weight = 0.6061868695705761;
			...
			this.xrTableCell38.Weight = 1.7671170240190242;
			...
			{
				new XRBinding("Text", null, "Summaries.Summaries_Summary.CostTotalSubTotal", "{0:#.00}")
			});
			...
			this.lblSummaryTotals.Text = "SOMMAIRE PAR GROUPES";
			...
			this.lblSummaryGroup.StylePriority.UseBackColor = false;
			...
			this.xrTable11.LocationFloat = new PointFloat(0f, 1f);
			...
			this.SubBand6.FormattingRules.Add(this.formattingRule16);
			...
			this.lblSummaryTax1.StylePriority.UseForeColor = false;
			...
			this.xrTableCell65.Font = new Font("Tahoma", 8.5f, FontStyle.Bold | FontStyle.Underline);
			...
			this.xrTableCell66.FormattingRules.Add(this.formattingRule15);
			...
			this.formattingRule16.DataMember = "Total";
			...
			this.SubBand7.FormattingRules.Add(this.formattingRule17);
			...
			this.lblSummaryTax2.StylePriority.UseForeColor = false;
			...
			this.xrTableCell73.Font = new Font("Tahoma", 8.5f, FontStyle.Bold | FontStyle.Underline);
			...
			this.xrTableCell74.FormattingRules.Add(this.formattingRule15);
			...
			this.formattingRule17.DataMember = "Total";
			...
			this.xrTable14.LocationFloat = new PointFloat(0f, 0.9999593f);
			...
			this.lblSummaryGrandTotal.StylePriority.UseForeColor = false;
			...
			this.xrTableCell82.FormattingRules.Add(this.formattingRule15);
			...
			this.xrTable6.LocationFloat = new PointFloat(124.9998f, 0f);
			...
			this.xrTable1.LocationFloat = new PointFloat(125f, 0f);
		...
		private void LoadResources()
		{
			...
			this.lblReportTitle.Text = Resources.RAPPORT_D_ESTIMATION__PAR_GROUPES_;
			...
			this.lblSummaryGroup.Text = Resources.Groupe;
		...
		public XtraReportEstimatingByGroups(Project project)
		{
