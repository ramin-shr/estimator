...
namespace QuoterPlan
{
	public class EELinkManager : UserControl
	{
		...
		private void InitializeComponent()
		{
			...
			this.btLink.Click += this.btLink_Click;
			...
			this.btRevokeLink.Click += this.btRevokeLink_Click;
			...
			this.txtDescription.Click += this.txt_Enter;
			this.txtDescription.Enter += this.txt_Enter;
			...
			this.txtPersonalKey.Click += this.txt_Enter;
			this.txtPersonalKey.Enter += this.txt_Enter;
			...
			this.txtKey.Click += this.txt_Enter;
			this.txtKey.Enter += this.txt_Enter;
			...
			this.txtItemID.Click += this.txt_Enter;
			this.txtItemID.Enter += this.txt_Enter;
			...
			base.Resize += this.EEManager_Resize;
		...
		public event EventHandler OnRevokeLink
		{
			add
			{
				EventHandler eventHandler = this.OnRevokeLink;
				EventHandler eventHandler2;
				do
				{
					eventHandler2 = eventHandler;
					EventHandler value2 = (EventHandler)Delegate.Combine(eventHandler2, value);
					eventHandler = Interlocked.CompareExchange<EventHandler>(ref this.OnRevokeLink, value2, eventHandler2);
				}
		...
		public EEInterface EEInterface
		{
			...
			get
			{
				return this.<EEInterface>k__BackingField;
			}
			[CompilerGenerated]
			set
			{
				this.<EEInterface>k__BackingField = value;
			}
		}
		...
		public EEExchangeData EEExchangeData
		{
			...
			get
			{
				return this.<EEExchangeData>k__BackingField;
			}
			[CompilerGenerated]
			set
			{
				this.<EEExchangeData>k__BackingField = value;
			}
		}
		...
		private void UpdateData()
		{
			...
			{
				this.txtItemID.Text = "(" + ((this.EEExchangeData.ItemType.ToUpper() == "A") ? Resources.Ensemble : Resources.Produit) + ") " + this.EEExchangeData.ItemID;
		...
		public void UpdateGUI()
		{
			...
			{
				flag = true;
				flag2 = this.EEExchangeData.IsValid();
			}
			this.lblNoLink.ForeColor = (flag ? Color.Black : Color.LightGray);
			this.btLink.Enabled = flag;
			this.lblNoLink.Visible = !flag2;
			this.btLink.Visible = !flag2;
			this.btRevokeLink.Visible = flag2;
			this.lblItemID.Visible = flag2;
			this.lblKey.Visible = flag2;
			this.lblPersonalKey.Visible = flag2;
			this.lblDescription.Visible = flag2;
			this.txtItemID.Visible = flag2;
			this.txtKey.Visible = flag2;
			this.txtPersonalKey.Visible = flag2;
			this.txtDescription.Visible = flag2;
			if (flag2)
			{
				this.UpdateData();
			}
		...
		{
			this.lblNoLink.Location = new Point((base.ClientSize.Width - this.lblNoLink.Size.Width) / 2, (base.ClientSize.Height - this.lblNoLink.Size.Height) / 2 - this.btLink.Height);
			this.btLink.Location = new Point((base.ClientSize.Width - this.btLink.Size.Width) / 2, this.lblNoLink.Top + this.lblNoLink.Height + 2);
			this.btRevokeLink.Location = new Point((base.ClientSize.Width - this.btRevokeLink.Size.Width) / 2, base.ClientSize.Height - (this.btRevokeLink.Height + 12));
		...
		private EventHandler OnRevokeLink;

		[CompilerGenerated]
		private EEInterface <EEInterface>k__BackingField;

		[CompilerGenerated]
		private EEExchangeData <EEExchangeData>k__BackingField;
	}
}
